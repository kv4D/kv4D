...
- 🏠 [A web application for building monitoring with BIM and point cloud technologies](https://github.com/ABASgroup/AirBIM) (backend and infrastructure)
- 🧠 [A web chat with local powered RAG for optimizing decision making](https://github.com/kv4D/memorizer)
